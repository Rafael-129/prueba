...
Route::get('/anuncios_profs', [AnunciosProfController::class, 'index'])->name('anuncios.index');
Route::get('/anuncios_profs/create', [AnunciosProfController::class, 'create'])->name('anuncios.create');
